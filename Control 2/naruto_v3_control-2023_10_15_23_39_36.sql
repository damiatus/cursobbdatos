...
--
-- Host: 127.0.0.1    Database: naruto_v3_control
-- ------------------------------------------------------
...
CREATE TABLE `interaccion` (
  `id_tinder` int(11) NOT NULL,
  `personaje_da` int(11) DEFAULT NULL,
  `personaje_recibe` int(11) DEFAULT NULL,
  `timestamp` datetime DEFAULT NULL,
  `tipo_interaccion` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_tinder`),
  KEY `interaccion_personaje_id_personaje_fk` (`personaje_da`),
  KEY `interaccion_personaje_id_personaje_fk2` (`personaje_recibe`),
  CONSTRAINT `interaccion_personaje_id_personaje_fk` FOREIGN KEY (`personaje_da`) REFERENCES `personaje` (`id_personaje`),
  CONSTRAINT `interaccion_personaje_id_personaje_fk2` FOREIGN KEY (`personaje_recibe`) REFERENCES `personaje` (`id_personaje`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,1,2,'2023-10-15 20:51:27','like'),
(2,1,3,'2023-10-15 20:52:57','superlike'),
(3,2,3,'2023-10-15 20:53:10','like'),
(4,1,4,'2023-10-15 21:12:12','like'),
(5,1,2,'2023-10-15 21:13:15','like'),
(6,24,25,'2023-10-15 21:57:53','like');
...
-- Dump completed on 2023-10-15 23:39:36
