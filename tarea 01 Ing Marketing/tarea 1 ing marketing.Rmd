...
set.seed(123)
setwd("C:/Users/crrfo/Desktop/tarea 01 Ing Marketing") #Seteamos el directorio de trabajo local
```
...
rentas_filtradas <- ventas %>% filter(ingreso >= lower_bound & ingreso <= upper_bound)
